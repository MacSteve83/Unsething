 ...
 *
 *  Purpose: class UnsethingQueryRetrieveIndexDatabaseHandle
 *
...
#include "dcmqrdba.h"    /* for class UnsethingQueryRetrieveDatabaseHandle */
 ...
 */
class UnsethingQueryRetrieveIndexDatabaseHandle: public UnsethingQueryRetrieveDatabaseHandle
{
public:
   ...
   */
  UnsethingQueryRetrieveIndexDatabaseHandle(
   ...
   *  @return EC_Normal upon normal completion, or some other OFCondition code upon failure.
   */
  OFCondition cancelFindRequest(UnsethingQueryRetrieveDatabaseStatus *status);
   ...
   *  @return EC_Normal upon normal completion, or some other OFCondition code upon failure.
   */
  OFCondition cancelMoveRequest(UnsethingQueryRetrieveDatabaseStatus *status);
 ...
 */
class UnsethingQueryRetrieveIndexDatabaseHandleFactory: public UnsethingQueryRetrieveDatabaseHandleFactory
{
public:
   ...
   */
  UnsethingQueryRetrieveIndexDatabaseHandleFactory(const UnsethingQueryRetrieveConfig *config);

  /// destructor
  virtual ~UnsethingQueryRetrieveIndexDatabaseHandleFactory();
   ...
   */
  virtual UnsethingQueryRetrieveDatabaseHandle *createDBHandle(
...
private:
  ...
  const UnsethingQueryRetrieveConfig *config_;
};
