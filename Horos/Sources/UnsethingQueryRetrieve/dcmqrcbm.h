...
class UnsethingQueryRetrieveOptions;
 ...
 */
class UnsethingQueryRetrieveMoveContext 
{
public:
    /** constructor
     ...
     */
    UnsethingQueryRetrieveMoveContext(
      UnsethingQueryRetrieveDatabaseHandle& handle,
      const UnsethingQueryRetrieveOptions& options,
      const UnsethingQueryRetrieveConfig *cfg,
      DIC_US priorstatus,
...
private:
    ...
    void moveNextImage(UnsethingQueryRetrieveDatabaseStatus * dbStatus);
    void failAllSubOperations(UnsethingQueryRetrieveDatabaseStatus * dbStatus);
    ...
    const UnsethingQueryRetrieveOptions& options_;
