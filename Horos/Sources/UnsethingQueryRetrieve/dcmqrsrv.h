 ...
 */
class UnsethingQueryRetrieveSCP
{
public:
...
//  UnsethingQueryRetrieveProcessTable processtable_;
  ...
  const UnsethingQueryRetrieveDatabaseHandleFactory& factory_;
