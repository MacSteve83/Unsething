 ...
 *
 *  Purpose: class UnsethingQueryRetrieveStoreContext
 *
...
//	UnsethingQueryRetrieveOptions *options = (UnsethingQueryRetrieveOptions*) [[params objectForKey: @"options"] pointerValue];
...
void UnsethingQueryRetrieveStoreContext::updateDisplay(T_DIMSE_StoreProgress * progress)
{
...
void UnsethingQueryRetrieveStoreContext::saveImageToDB(
    ...
    DcmDataset **stDetail)
{
    ...
    UnsethingQueryRetrieveDatabaseStatus dbStatus(STATUS_Success);
    ...
    {    
        ...
        if (dbcond.bad())
        {
            UnsethingQueryRetrieveOptions::errmsg("storeSCP: Database: storeRequest Failed (%s)",
...
void UnsethingQueryRetrieveStoreContext::writeToFile(
    DcmFileFormat *ff,
    const char* fname,
...
void UnsethingQueryRetrieveStoreContext::checkRequestAgainstDataset(
    ...
    OFBool uidPadding)          /* correct UID passing */
{
    ...
    {
        UnsethingQueryRetrieveOptions::errmsg("Bad image file: %s", fname);
...
void UnsethingQueryRetrieveStoreContext::callbackHandler(
    /* in */
