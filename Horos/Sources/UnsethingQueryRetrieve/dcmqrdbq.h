 ...
 */
class UnsethingQueryRetrieveOsiriXDatabaseHandle: public UnsethingQueryRetrieveDatabaseHandle
{
public:
   ...
   */
  UnsethingQueryRetrieveOsiriXDatabaseHandle(
 ...
 */
class UnsethingQueryRetrieveOsiriXDatabaseHandleFactory: public UnsethingQueryRetrieveDatabaseHandleFactory
{
public:
   ...
   */
  UnsethingQueryRetrieveOsiriXDatabaseHandleFactory();

  /// destructor
  virtual ~UnsethingQueryRetrieveOsiriXDatabaseHandleFactory();
