 ...
 *  Source File:      $Source: /cvsroot/osirix/osirix/Binaries/dcmtk-source/dcmqrdb/dcmqropt.cc,v $
...
UnsethingQueryRetrieveOptions::UnsethingQueryRetrieveOptions()
...
void UnsethingQueryRetrieveOptions::errmsg(const char* msg, ...)
{
    va_list args;

    fprintf(stderr, "UnsethingQueryRetrieve: ");
    va_start(args, msg);
