...
const OFConditionConst DcmQROsiriXDatabaseErrorC = {OFM_dcmqrdb, 0x001, OF_error, "DcmQR Index Database Error"};
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::pruneInvalidRecords()
{
    return (EC_Normal) ;
}
...
Log Entry
*************/
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::updateLogEntry(DcmDataset *dataset)
{
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::startFindRequest(
...
//	findRequestIdentifiers->print(std::cout);
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::testFindRequestList (
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::nextFindResponse (
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::cancelFindRequest (UnsethingQueryRetrieveDatabaseStatus *status)
{
	return DcmQROsiriXDatabaseError;
}
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::nextMoveResponse(
      char *SOPClassUID,
      char *SOPInstanceUID,
      char *imageFileName,
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::startMoveRequest(
        const char      *SOPClassUID,
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::cancelMoveRequest (UnsethingQueryRetrieveDatabaseStatus *status)
{
	return DcmQROsiriXDatabaseError;
}
...
UnsethingQueryRetrieveOsiriXDatabaseHandle::UnsethingQueryRetrieveOsiriXDatabaseHandle(
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::makeNewStoreFileName(
                const char      *SOPClassUID,
...
OFCondition UnsethingQueryRetrieveOsiriXDatabaseHandle::storeRequest(
      const char *SOPClassUID,
      const char *SOPInstanceUID,
...
const char *UnsethingQueryRetrieveOsiriXDatabaseHandle::getStorageArea() const
{
  return handle->storageArea;
}
/*
const char *UnsethingQueryRetrieveOsiriXDatabaseHandle::getIndexFilename() const
{
  return handle->indexFilename;
}
*/

void UnsethingQueryRetrieveOsiriXDatabaseHandle::setDebugLevel(int dLevel)
{
    debugLevel = dLevel;
}

int UnsethingQueryRetrieveOsiriXDatabaseHandle::getDebugLevel() const
{
    return debugLevel;
}

void UnsethingQueryRetrieveOsiriXDatabaseHandle::dbdebug(int level, const char* format, ...) const
{
    va_list ap;
...
void UnsethingQueryRetrieveOsiriXDatabaseHandle::setIdentifierChecking(OFBool checkFind, OFBool checkMove)
{
...
UnsethingQueryRetrieveOsiriXDatabaseHandleFactory::UnsethingQueryRetrieveOsiriXDatabaseHandleFactory()
...
UnsethingQueryRetrieveDatabaseHandle *UnsethingQueryRetrieveOsiriXDatabaseHandleFactory::createDBHandle(
    const char * callingAETitle,
    const char *calledAETitle,
    OFCondition& result) const
{
  return new UnsethingQueryRetrieveOsiriXDatabaseHandle( callingAETitle, result);
}
