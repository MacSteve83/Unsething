 ...
 *
 *  Purpose: class UnsethingQueryRetrieveProcessTable
 *
 ...
 */
class UnsethingQueryRetrieveProcessTable
{
public:
  /// default constructor
  UnsethingQueryRetrieveProcessTable() { }

  /// destructor
  virtual ~UnsethingQueryRetrieveProcessTable();
...
private:
  ...
  OFList<UnsethingQueryRetrieveProcessSlot *> table_;
};
