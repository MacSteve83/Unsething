 ...
 */
class UnsethingQueryRetrieveGetContext
{
public:
    /** constructor
     ...
     */
    UnsethingQueryRetrieveGetContext(UnsethingQueryRetrieveDatabaseHandle& handle,
...
private:
    ...
    void getNextImage(UnsethingQueryRetrieveDatabaseStatus * dbStatus);
