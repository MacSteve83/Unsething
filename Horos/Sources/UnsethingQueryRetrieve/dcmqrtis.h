...
struct TI_DBEntry
{
    ...
    UnsethingQueryRetrieveDatabaseHandle *dbHandle;  /* handle to current db */
 ...
 */
class UnsethingQueryRetrieveTelnetInitiator
{
public:
     ...
     */
    UnsethingQueryRetrieveTelnetInitiator(UnsethingQueryRetrieveConfig &cfg);
