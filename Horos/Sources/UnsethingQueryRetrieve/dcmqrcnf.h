 ...
 */
struct UnsethingQueryRetrieveConfigQuota
{
 ...
 */
struct UnsethingQueryRetrieveConfigPeer
{
 ...
 */
struct UnsethingQueryRetrieveConfigAEEntry
{
 ...
 */
struct UnsethingQueryRetrieveConfigHostTable
{
    /// number of entries
    int noOfHostEntries;

    /// array of entries
    UnsethingQueryRetrieveConfigHostEntry   *HostEntries;
};

/** this class describes configuration settings for a Query/Retrieve SCP Service
 */
class UnsethingQueryRetrieveConfig
{
...
private:
   ...
   */
  UnsethingQueryRetrieveConfigPeer *parsePeers(char **valuehandle, int *peers);
   ...
   *  Return : pointer to peer list
   */
  UnsethingQueryRetrieveConfigPeer *readPeerList(char **valuehandle, int *peers);
   ...
   */
  static UnsethingQueryRetrieveConfigQuota *parseQuota(char **valuehandle);
  ...
  UnsethingQueryRetrieveConfigConfiguration CNF_Config;   /* configuration file contents */
  UnsethingQueryRetrieveConfigHostTable CNF_HETable;      /* HostEntries Table */
  UnsethingQueryRetrieveConfigHostTable CNF_VendorTable;  /* Vendor Table */
