 ...
 *
 *  Purpose: class UnsethingQueryRetrieveDatabaseHandle
 *
...
class DcmDataset;
class UnsethingQueryRetrieveDatabaseStatus;
 ...
 */
class UnsethingQueryRetrieveDatabaseHandle
{
public:

  /// default constructor
  UnsethingQueryRetrieveDatabaseHandle() { }
   ...
   */
   virtual ~UnsethingQueryRetrieveDatabaseHandle();
  ...
  virtual OFCondition startFindRequest(
      ...
      UnsethingQueryRetrieveDatabaseStatus *status) = 0;
   ...
   *  @return EC_Normal upon normal completion, or some other OFCondition code upon failure.
   */
  virtual OFCondition cancelFindRequest(UnsethingQueryRetrieveDatabaseStatus *status) = 0;
   ...
   *  @return EC_Normal upon normal completion, or some other OFCondition code upon failure.
   */
  virtual OFCondition cancelMoveRequest(UnsethingQueryRetrieveDatabaseStatus *status) = 0;
 ...
 */
class UnsethingQueryRetrieveDatabaseHandleFactory
{
public:
  ...
  /** Virtual Destructor
   */
  virtual ~UnsethingQueryRetrieveDatabaseHandleFactory() {}
