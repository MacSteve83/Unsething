...
public:
   ...
   */
  UnsethingQueryRetrieveDatabaseStatus(Uint16 s = 0);

  /// copy constructor
  UnsethingQueryRetrieveDatabaseStatus(const UnsethingQueryRetrieveDatabaseStatus& org);

  /// destructor
  ~UnsethingQueryRetrieveDatabaseStatus();

  /// copy assignment operator
  UnsethingQueryRetrieveDatabaseStatus& operator=(const UnsethingQueryRetrieveDatabaseStatus& org);
