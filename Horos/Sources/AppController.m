...
{
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"mailto:unsething@gmail.com?subject=Unsething%20Professional%20Support"]];
}
...
//                [[NSUserDefaults standardUserDefaults] setObject:@"1" forKey:@"allow_qr_custom_dicom_field"];
                ...
                if ([dataBasePath hasPrefix:@"/Volumes/"] || dataBasePath == nil) {
                    ...
                    if (![[NSFileManager defaultManager] fileExistsAtPath:volumePath]) {
                        NSPanel* dialog = [NSPanel alertWithTitle:@"Unsething Data"
                ...
                dataBasePath = [DicomDatabase baseDirPathForPath:dataBasePath]; // we know this is the "../Unsething Data" path
...
{
    [NSApp setApplicationIconImage: [NSImage imageNamed: @"Unsething.icns"]];
	unlink( "/tmp/kill_all_storescu");
