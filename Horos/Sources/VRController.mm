...
- (void) setupToolbar {
    ...
    if( [style isEqualToString:@"standard"]) toolbar = [[OsiriXToolbar alloc] initWithIdentifier: VRStandardToolbarIdentifier];
    else toolbar = [[OsiriXToolbar alloc] initWithIdentifier: VRPanelToolbarIdentifier];
